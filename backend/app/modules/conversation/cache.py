...
def invalidate_trainer_persona(trainer_id: str, *, reason: str | None = None) -> None:
    get_chat_cache().delete(trainer_persona_key(trainer_id))
    logger.info(
        "trainer_persona_cache_invalidated trainer_id=%s reason=%s",
        trainer_id,
        reason or "unspecified",
    )


def invalidate_chat_context(
    trainer_id: str,
    client_id: str,
    *,
    ...
    get_chat_cache().delete(*keys)
    logger.info(
        "chat_cache_invalidated trainer_id=%s client_id=%s reason=%s include_trainer_persona=%s",
        trainer_id,
        client_id,
        reason or "unspecified",
