...
const MODE_THEME_TOKENS = {
  build: {
    key: 'BUILD',
    label: 'Build',
    displayLabel: 'BUILD MODE',
    accent: BASE.blue500,
    accentStrong: BASE.blue520,
    accentSoft: withAlpha(BASE.blue500, 0.18),
    background: BASE.navy950,
    backgroundAlt: BASE.navy900,
    glowPrimary: withAlpha(BASE.blue500, 0.28),
    glowSecondary: withAlpha(BASE.blue420, 0.16),
    cardFill: withAlpha(BASE.blue500, 0.1),
    cardBorder: withAlpha(BASE.blue520, 0.34),
    navFill: withAlpha(BASE.blue500, 0.24),
    navBorder: withAlpha(BASE.blue520, 0.4),
    navShadow: withAlpha(BASE.blue500, 0.36),
  },
  beast: {
    key: 'BEAST',
    label: 'Beast',
    displayLabel: 'BEAST MODE',
    accent: BASE.rose420,
    accentStrong: '#F2A08E',
    accentSoft: withAlpha(BASE.rose420, 0.18),
    background: BASE.navy950,
    backgroundAlt: '#140F18',
    glowPrimary: withAlpha(BASE.rose420, 0.26),
    glowSecondary: withAlpha(BASE.amber420, 0.12),
    cardFill: withAlpha(BASE.rose420, 0.1),
    cardBorder: withAlpha(BASE.rose420, 0.36),
    navFill: withAlpha(BASE.rose420, 0.22),
    navBorder: withAlpha(BASE.rose420, 0.4),
    navShadow: withAlpha(BASE.rose420, 0.34),
  },
  recover: {
    key: 'RECOVER',
    label: 'Recover',
    displayLabel: 'RECOVER MODE',
    accent: BASE.green420,
    accentStrong: '#8FC9A9',
    accentSoft: withAlpha(BASE.green420, 0.16),
    background: BASE.navy950,
    backgroundAlt: '#071B1C',
    glowPrimary: withAlpha(BASE.green420, 0.22),
    glowSecondary: withAlpha(BASE.blue420, 0.1),
    cardFill: withAlpha(BASE.green420, 0.09),
    cardBorder: withAlpha(BASE.green420, 0.34),
    navFill: withAlpha(BASE.green420, 0.2),
    navBorder: withAlpha(BASE.green420, 0.38),
    navShadow: withAlpha(BASE.green420, 0.3),
  },
  rest: {
    key: 'REST',
    label: 'Rest',
    displayLabel: 'REST MODE',
    accent: BASE.blue360,
    accentStrong: BASE.blue520,
    accentSoft: withAlpha(BASE.blue360, 0.18),
    background: BASE.navy950,
    backgroundAlt: BASE.navy850,
    glowPrimary: withAlpha(BASE.blue360, 0.2),
    glowSecondary: withAlpha(BASE.blue500, 0.08),
    cardFill: withAlpha(BASE.blue360, 0.09),
    cardBorder: withAlpha(BASE.blue360, 0.32),
    navFill: withAlpha(BASE.blue360, 0.2),
    navBorder: withAlpha(BASE.blue360, 0.36),
    navShadow: withAlpha(BASE.blue360, 0.28),
  },
  fallback: {
    key: 'BASE',
    label: 'Base',
    displayLabel: 'TODAY MODE',
    accent: BASE.blue500,
    accentStrong: BASE.blue520,
    accentSoft: withAlpha(BASE.blue500, 0.16),
    background: BASE.navy950,
    backgroundAlt: BASE.navy900,
    glowPrimary: GLASS.atmosphereBlue,
    glowSecondary: GLASS.atmosphereWarm,
    cardFill: GLASS.heroFill,
    cardBorder: GLASS.borderHero,
    navFill: withAlpha(BASE.blue500, 0.24),
    navBorder: withAlpha(BASE.blue520, 0.38),
    navShadow: withAlpha(BASE.blue500, 0.32),
  },
};

const MEMORY_CHIP_TOKENS = {
  fill: GLASS.elevatedFill,
  fillActive: GLASS.activeFill,
  fillEditing: GLASS.inputFill,
  fillDelete: withAlpha(BASE.rose420, 0.16),
  border: GLASS.borderDefault,
  borderActive: GLASS.borderActive,
  borderEditing: GLASS.borderHero,
  borderDelete: withAlpha(BASE.rose420, 0.42),
  badgeFill: withAlpha(BASE.rose420, 0.92),
  badgeText: BASE.textPrimary,
  hintText: BASE.textTertiary,
};
...
export const theme = {
  modes: MODE_THEME_TOKENS,
  memoryChip: MEMORY_CHIP_TOKENS,
