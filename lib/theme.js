...
const BASE = {
  ...
  textPrimary: '#DCE6FA',
  textSecondary: '#B8C7E7',
  textTertiary: '#90A2C7',
  textDisabled: '#64779F',
};

const GLASS = {
  baseFill: 'rgba(200, 218, 252, 0.055)',
  elevatedFill: 'rgba(212, 227, 255, 0.068)',
  activeFill: 'rgba(220, 233, 255, 0.082)',
  inputFill: 'rgba(223, 235, 255, 0.082)',
  scrimFill: 'rgba(7, 12, 23, 0.78)',
  overlayFill: 'rgba(8, 14, 26, 0.86)',
  borderSoft: 'rgba(233, 241, 255, 0.11)',
  borderDefault: 'rgba(233, 241, 255, 0.16)',
  borderStrong: 'rgba(233, 241, 255, 0.22)',
  borderActive: 'rgba(126, 171, 255, 0.30)',
  topHighlight: 'rgba(247, 250, 255, 0.11)',
  edgeHighlight: 'rgba(247, 250, 255, 0.16)',
  cornerHighlight: 'rgba(255, 255, 255, 0.05)',
  innerLift: 'rgba(255, 255, 255, 0.018)',
  innerShade: 'rgba(4, 8, 16, 0.18)',
  interiorTop: 'rgba(255, 255, 255, 0.06)',
  interiorMid: 'rgba(255, 255, 255, 0.012)',
  interiorBottom: 'rgba(4, 8, 16, 0.16)',
...
export const theme = {
  colors: {
    ...
    cta: {
      primaryBg: withAlpha(BASE.blue500, 0.3),
      primaryBorder: withAlpha(BASE.blue520, 0.42),
    ...
    nav: {
      activeBg: withAlpha(BASE.blue500, 0.16),
