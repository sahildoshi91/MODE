...
| `REDIS_URL` | Optional read-through cache backend for chat digest/persona/context keys. | Redis/cache provider secret manager. | local optional; staging/prod recommended for latency SLOs. | Yes | No | `<redis://cache-host:6379/0>` |
